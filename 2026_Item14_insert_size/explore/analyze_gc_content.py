#!/usr/bin/env python3
"""
Analyze GC content distribution to confirm primer dimer contamination.

This script calculates GC content for merged reads and compares with 
expected mammalian genomic DNA ranges.
"""
